...
type BooksContextType = {
  books: Book[];
  createBook: (title: string, description?: string, theme?: string, password?: string, userId?: string) => Promise<Book>;
...
export const BooksProvider = ({ children }: { children: ReactNode }) => {
  ...
  const createBook = async (title: string, description?: string, theme?: string, password?: string, userId?: string) => {
    const newBook: Book = {
